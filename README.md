...
| 0xb7e4e93fbabf3904d28564574b3692293e6ea476 | ETH | 46850000000000000000 |
...
| 0x26bf32bb4efc2c6c73c3819ad7adf18c494d9afe | ETH | 1960000000000000000 |

## Verify

**make sure you have dapple installed on your system**
...
3. build the project
`npm build`
4. make sure you have an ethereum homestead chain running under localhost:8545,
otherwise edit your rpc endpoint in the `index.js` file
5. run the script
`npm run`
...
var saveBalances = function (addresses, balances, cb) {
  ...
  console.log("Total Sum:", web3.fromWei(totalSum,'ether'));
...
```
  ...
  fs.writeFileSync(JSON.stringify(balances, false, 2), 'simpleMarket.json');
}
